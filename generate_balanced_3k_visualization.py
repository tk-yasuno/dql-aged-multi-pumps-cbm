#!/usr/bin/env python3
"""
Balanced 3000-Episode Training Results Visualization
Outputs: run_3K_episodes/outputs_pump_cbm_v047_balanced/balanced_training_results.png
"""
...
def create_balanced_training_visualization():
    """Create comprehensive training results visualization for Balanced strategy"""
    ...
    # Load training data
    input_path = "outputs_pump_cbm_v047_balanced/training_history.json"
    ...
    fig.suptitle('Balanced Strategy: 3000-Episode Training Results', 
    ...
    color_primary = '#ff7f0e'  # Orange for Balanced
    ...
    print(f"🎨 Balanced training results saved: {output_path}")
...
if __name__ == "__main__":
    print("[INFO] Generating Balanced 3000-Episode Training Results Visualization...")
    success = create_balanced_training_visualization()
    if success:
