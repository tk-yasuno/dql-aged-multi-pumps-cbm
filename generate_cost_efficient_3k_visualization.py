#!/usr/bin/env python3
"""
Cost-Efficient 3000-Episode Training Results Visualization
Outputs: run_3K_episodes/outputs_pump_cbm_v047_cost_efficient/cost_efficient_training_results.png
"""
...
def create_cost_efficient_training_visualization():
    """Create comprehensive training results visualization for Cost-Efficient strategy"""
    ...
    # Load training data
    input_path = "outputs_pump_cbm_v047_cost_efficient/training_history.json"
    ...
    fig.suptitle('Cost-Efficient Strategy: 3000-Episode Training Results', 
    ...
    color_primary = '#2ca02c'  # Green for Cost-Efficient
    ...
    bp = axes[0, 1].boxplot(phase_data, tick_labels=range(1, n_phases+1), patch_artist=True)
    ...
    output_path = output_dir / "cost_efficient_training_results.png"
    plt.savefig(output_path, dpi=300, bbox_inches='tight', facecolor='white')
    
    print(f"🎨 Cost-Efficient training results saved: {output_path}")
...
if __name__ == "__main__":
    print("[INFO] Generating Cost-Efficient 3000-Episode Training Results Visualization...")
    success = create_cost_efficient_training_visualization()
    if success:
